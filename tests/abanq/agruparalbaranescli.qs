...
function interna_init()
{
		...
		tblAlbaranes.setColumnLabels("/", "Incluir/Código/Fecha/Total/Cliente/Nombre/idalbaran");
...
function oficial_actualizar()
{
		...
		while (curAlbaranes.next()) {
				...
				with(tblAlbaranes) {
						...
						setText(0, 3, util.roundFieldValue(curAlbaranes.valueBuffer("total"), "albaranescli", "total"));
						setText(0, 4, curAlbaranes.valueBuffer("codcliente"));
						setText(0, 5, curAlbaranes.valueBuffer("nombrecliente"));
