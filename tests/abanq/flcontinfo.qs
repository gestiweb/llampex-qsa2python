...
class oficial extends interna {
	...
	function numerarFacturas()  {
			return this.ctx.oficial_numerarFacturas();
	}
...
class ifaceCtx extends head {
	...
	function pub_numerarFacturas()  {
			return this.numerarFacturas();
	}
...
function oficial_cabeceraInforme(nodo:FLDomNode, campo:String):String
{
		...
		case "balancesis":
				...
				qCondiciones.
						setSelect
						("descripcion,i_co__subcuentas_codejercicio,d_co__asientos_fecha,h_co__asientos_fecha,d_co__subcuentas_codsubcuenta,h_co__subcuentas_codsubcuenta,codejercicioant,fechaant_d,fechaant_h");
		...
		case "fecha":
				...
				texto = "Fecha: " + util.dateAMDtoDMA(texFecha.left(10)) + " ";
				break;
...
I.V.A. con numeración automática \end */
function oficial_numerarFacturas() 
{
 	return this.iface.numFactura++;
}
...
function oficial_acumularValoresEmi(nodo:FLDomNode, campo:String):String
{
	var util:FLUtil = new FLUtil;
	var ctaIva:Array = [];
	ctaIva = flfacturac.iface.pub_datosCtaEspecial("IVARUE", nodo.attributeValue("co_asientos.codejercicio"));

	if (ctaIva.error == 0) {
		if (ctaIva.idsubcuenta == nodo.attributeValue("co_partidas.idsubcuenta")) {
			this.iface.baseImpUE +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible"));
			this.iface.ivaUE +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.iva")) / 100;
			this.iface.reUE +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.recargo")) / 100;
			this.iface.totalUE = parseFloat(this.iface.baseImpUE + this.iface.ivaUE + this.iface.reUE);
		}
	}
	if ( nodo.attributeValue("co_partidas.iva") == 4 ) {
		this.iface.baseImp4 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible"));
		this.iface.iva4 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.iva")) / 100;
		this.iface.re4 += parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.recargo")) / 100;
		this.iface.total4 = this.iface.baseImp4 + this.iface.iva4 + this.iface.re4;
	}
	if ( nodo.attributeValue("co_partidas.iva") == 7 ) {
		this.iface.baseImp7 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible"));
		this.iface.iva7 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.iva")) / 100;
		this.iface.re7 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.recargo")) / 100;
		this.iface.total7 = this.iface.baseImp7 + this.iface.iva7 + this.iface.re7;
	}
	if ( nodo.attributeValue("co_partidas.iva") == 16 ) {
		this.iface.baseImp16 += parseFloat(nodo.attributeValue("co_partidas.baseimponible"));
		this.iface.iva16 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.iva")) / 100;
		this.iface.re16 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) *  parseFloat(nodo.attributeValue("co_partidas.recargo")) / 100;
...
function oficial_acumularValoresRec(nodo:FLDomNode, campo:String):String
{
	var util:FLUtil = new FLUtil;
	var ctaIva:Array;
	ctaIva = flfacturac.iface.pub_datosCtaEspecial("IVASUE", nodo.attributeValue("co_asientos.codejercicio"));
