...
function interna_init()
{
	...
	if (cursor.modeAccess() == cursor.Insert) {
		...
		var fechaInicioActual:String = util.sqlSelect("ejercicios", "fechainicio", "codejercicio = '" + this.iface.ejercicioActual + "'");
		this.iface.ejercicioAnterior = util.sqlSelect("ejercicios", "codejercicio", "fechafin < '" + fechaInicioActual + "' ORDER BY fechafin DESC");
		if (!this.iface.ejercicioAnterior) {
			this.iface.ejercicioAnterior = this.iface.ejercicioActual;
			this.iface.unicoEjercicio();
		}
		this.child("fdbEjercicioAct").setValue(this.iface.ejercicioActual);
		this.child("fdbEjercicioAnt").setValue(this.iface.ejercicioAnterior);
		this.iface.todasSubcuentas();
	} else {
		this.iface.ejercicioActual = this.child("fdbEjercicioAct").value();
		this.iface.ejercicioAnterior = this.child("fdbEjercicioAnt").value();
		if (this.iface.ejercicioActual == this.iface.ejercicioAnterior) {
			this.iface.unicoEjercicio();
		}
	}
