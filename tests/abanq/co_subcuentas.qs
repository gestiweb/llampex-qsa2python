...
class oficial extends interna {
	...
	function habilitarIVA() { return this.ctx.oficial_habilitarIVA(); }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function interna_validateForm()
{
		...
		if (cursor.isNull("idcuenta")) {
			MessageBox.warning(util.translate("scripts", "Debe seleccionar una cuenta que exista en la tabla de cuentas "), MessageBox.Ok, MessageBox.NoButton, MessageBox.NoButton);
			return false;
		}
